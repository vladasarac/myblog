<h1>Congratulation {{ $user->name }}, You are pronaunced for MyBlog.dev Administrator</h1>
...
<div>
  ...
  <p>
  	<a href="http://myblog.localhost/admin/authors/posts/{{ $user->id }}">Visit your profile </a>
  </p>
</div>
